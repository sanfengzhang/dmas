 ...
 */
public final class ListMultimapRecord {

  private ArrayListMultimap<String, Object> fields;

  /** Creates a new empty record. */
  public ListMultimapRecord() {
    this(create());
  }

  private ListMultimapRecord(ArrayListMultimap<String, Object> fields) {
    Preconditions.checkNotNull(fields);
    this.fields = fields;
  }

  /** Returns a shallow copy of this record. */
  public ListMultimapRecord copy() {
    ...
    copy.putAll(fields);
    return new ListMultimapRecord(copy);
  }
...
//    fields.replaceValues(key, Collections.singletonList(value)); // unnecessarily slow
  ...
  public boolean equals(Object other) {
    if (other instanceof ListMultimapRecord) {
      return fields.equals(((ListMultimapRecord)other).getFields());
    }
    return false;
  }
