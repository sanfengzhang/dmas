 ...
 */
package com.hanl.etl.shaded.com.googlecode.jcsv.fastreader;
 ...
 *
 */
public final class SimpleCSVTokenizer<T> implements CSVTokenizer<T> {
  ...
  @Override
  public boolean tokenizeLine(String line, BufferedReader reader, T record) throws IOException {
  ...
  private void put(String line, int start, int i, int j, T record) {
